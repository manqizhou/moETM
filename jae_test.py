...
#dataset_path = local_add + 'sample_data/openproblems_bmmc_multiome_starter/openproblems_bmmc_multiome_starter.'
...
par = {
    ...
    'input_pretrain': 'pretrained',
    'output': 'output.h5ad',
}

meta = { 'resources_dir': '.', 'functionality_name': 'jae_test' }
