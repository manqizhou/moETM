...
local_add = '/home/zbai/NeurIPS2021_SingleCell/Starter_kits/joint_embedding/starter_kit-joint_embedding-python_competition/'

dataset_path = local_add + 'output/datasets_phase2/joint_embedding/openproblems_bmmc_multiome_phase2/openproblems_bmmc_multiome_phase2.censor_dataset.output_'
par = {
    'input_mod1': f'{dataset_path}mod1.h5ad',
    'input_mod2': f'{dataset_path}mod2.h5ad',
    'input_explore_mod1': '../multiome/multiome_gex_processed_training.h5ad', # From /datasets_explore
    'input_explore_mod2': '../multiome/multiome_atac_processed_training.h5ad', # From /datasets_explore
    'output_pretrain': 'pretrained',#'...',
    'tf_seed': 46,
    'np_seed': 56
}
...
# Section 1: PCA PRETRAIN on small training data
...
# Section 1 comment: this section is useful in testing phase. However, it is NOT involved in training the JAE network.
